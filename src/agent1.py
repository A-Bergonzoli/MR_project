...
class Agent_1():
    ...
    def __init__(self):
        ...
        # Printo sulla shell
        rospy.loginfo("Starting agent_1!")
    ...
    # Tells us whether or not a given agent is neighbour of agent_1
    ...
    # Defines the neighbour set for agent_1
...
if __name__ == "__main__":
    # Instance an object of the 'Agent_1' class
    ob = Agent_1()
